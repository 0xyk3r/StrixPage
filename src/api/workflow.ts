...
export const workflowApi = {
  ...
  definitionUpdate: (
    id: string,
    data: { name?: string; category?: string; description?: string; iconUrl?: string },
  ) =>
  ...
  versionDetail: (definitionId: string, versionId: string) =>
    http.get<RetResult<WfDefinitionVersion>>(
      `workflow/definitions/${definitionId}/versions/${versionId}`,
      {
  ...
  versionPublish: (definitionId: string, versionId: string) =>
    http.post<RetResult>(
      `workflow/definitions/${definitionId}/versions/${versionId}/publish`,
      null,
      {
  ...
  instanceGraph: (id: string) =>
    http.get<RetResult<{ graphJson: string; activeNodeIds: string[]; completedNodeIds: string[] }>>(
      `workflow/instances/${id}/graph`,
      {
